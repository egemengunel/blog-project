...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "322c5497-fdfd-4e3b-9cc4-91a69b151638",
  ...
  "public": {
    "supabaseUrl": "https://tqlettuoslsoelvllqbr.supabase.co",
    "supabaseAnonKey": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRxbGV0dHVvc2xzb2VsdmxscWJyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTA2NjM2MzcsImV4cCI6MjA2NjIzOTYzN30.0LvjTj4OzYJlDPqTW1IOqJba6z4BOay_iyKY1oVSH3Q",
    "content": {
      "wsUrl": ""
    },
    "mdc": {
  ...
  "databaseUrl": "postgresql://postgres.tqlettuoslsoelvllqbr:dyhbyg-0sufde-dyffaS@aws-0-eu-north-1.pooler.supabase.com:6543/postgres?pgbouncer=true",
  "directUrl": "postgresql://postgres.tqlettuoslsoelvllqbr:dyhbyg-0sufde-dyffaS@aws-0-eu-north-1.pooler.supabase.com:5432/postgres",
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/egemengunel/Documents/WeDance/blog-app/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _iKQ9NV = eventHandler(async (event) => {
...
const _ylMh97 = eventHandler(async (event) => {
...
const _lazy_K1oeJr = () => import('../routes/api/trpc/_trpc_.mjs');
const _lazy_f3lAqy = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/api/trpc/:trpc', handler: _lazy_K1oeJr, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_f3lAqy, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _iKQ9NV, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _ylMh97, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_f3lAqy, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, withQuery as A, withTrailingSlash as B, withoutTrailingSlash as C, isScriptProtocol as D, sanitizeStatusCode as E, baseURL as F, createHooks as G, executeAsync as H, toRouteMatcher as I, createRouter$1 as J, defu as K, hash$1 as L, getRequestHeaders as M, withLeadingSlash as N, headSymbol as O, useHead as P, listener as Q, getRequestWebStream as a, getResponseStatusText as b, getResponseStatus as c, appId as d, eventHandler as e, defineRenderHandler as f, getRequestURL as g, buildAssetsURL as h, appTeleportTag as i, appTeleportAttrs as j, getQuery as k, createError$1 as l, createSSRContext as m, appHead as n, getRouteRules as o, publicAssetsURL as p, getRenderer as q, getEntryIds as r, setSSRError as s, renderInlineStyles as t, replaceIslandTeleports as u, useNitroApp as v, parseQuery as w, hasProtocol as x, joinURL as y, getContext as z };
